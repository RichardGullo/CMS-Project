...
function requestTable()
{
    ...
    fetch("http://192.168.86.34/JADAR/LAMPAPI2/populate.php", {
        method:"POST",
        body:formData
    }).then(function(res){
        return res.json();
...
$("#confirm-edit").click(function()
{
    ...
    fetch("http://192.168.86.34/JADAR/LAMPAPI2/editContact.php", {
        method:"POST",
        body:formData
    }).then(function(){
...
$("#confirm-add").click(function()
{
        ...
        fetch("http://192.168.86.34/JADAR/LAMPAPI2/addContact.php", {
            method:"POST",
            body:formData
        }).then(function(){
...
$("#confirm-delete").click(function()
{
    ...
    fetch("http://192.168.86.34/JADAR/LAMPAPI2/deleteContact.php", {
        method:"POST",
        body:formData
    }).then(function(){
